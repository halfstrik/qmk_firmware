...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        KC_SPC,   KC_LCMD,KC_ESC,   KC_LALT,  MO(_FN), KC_LCTL, KC_ENTER,KC_RCTL, KC_RALT, KC_DEL,   KC_RCMD, KC_BSPC
    ),
    [_FN] = LAYOUT(
...
led_config_t g_led_config = {
    ...
    {
        // Row 0 — number row
        { 24    , 23    , 14    , 13    , 4,      3,      43    , 44     , 53    , 54    , 63     , 64    },
        // Row 1 — Q row
        { 25    , 22    , 15    , 12    , 5,      2,      42    , 45     , 52    , 55    , 62     , 65    },
        // Row 2 — A row
        { 26    , 21    , 16    , 11    , 6,      1,      41    , 46     , 51    , 56    , 61     , 66    },
        // Row 3 — Z row
        { 27    , 20    , 17    , 10,     7,      0,      40    , 47     , 50    , 57    , 60     , 67    },
        // Row 4 — arrows, misc
        { NO_LED, 19    , 18    , 9,      8,      NO_LED, NO_LED, 48     , 49    , 58    , 59    , NO_LED },
        // Row 5 — thumbs
        { 28,     29,    30,     31,      33,     32    , 35    , 34     , 36    , 37    , 38    , 39     }
    },
